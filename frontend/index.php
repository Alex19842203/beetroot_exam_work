...
?>
                <form action="index.php" method="POST" align="center" style="vertical-align: middle; margin-top: 15%">
                    <h2>Sign in</h2>
                    <p><label for="inputEmail"></label>
                    <input type="email" name="inputEmail" id="inputEmail" placeholder="Email address ..." required autofocus></p>

                    <p><label for="inputPass"></label>
                    <input type="password" name="inputPass" id="inputPass" placeholder="Password ..." required></p>
